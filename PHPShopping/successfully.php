	...
	<div class="container">
		...
		<?php 
			...
			if ($showOrder) {
			 ...
			 <div class="main-suss">
			 	<div class="aleerrt">
					<span class="success_note">Tổng giá trị bạn đã mua: 
		                <?php echo $result['price']?>
		             </span>
		             <br/>
		            <span class="success_note">Chúng tôi sẽ liên hệ với bạn sớm nhất có thể, xem chi tiết đặt hàng tại <a href="order-detail.php">Bấm vào đây</a></span>
       		 	</div>
            <div class="box">
				<div class="title-cate-box">
					<div class="title-cate">
						<h2 class="title-pro">Gợi ý cho bạn</h2>
